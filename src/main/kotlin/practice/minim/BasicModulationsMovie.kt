...
class BasicModulationsMovie : RecorderablePAppletMinim() {
    private var bgColor: Int = 0
    private lateinit var fft: FFT
    private lateinit var filePlayer: FilePlayer
    private var type = 0

    private val wavFilePath = "../out/wav/basicModulations.wav"
    ...
    private fun showWave() {
        ...
        beginShape()
        stroke(0f, 0f, 0f)
        val min = out.right.toArray().minOrNull()
        if (min!! < 0F) {
