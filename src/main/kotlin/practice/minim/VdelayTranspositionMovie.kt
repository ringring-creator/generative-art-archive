...
class VdelayTranspositionMovie : RecorderablePAppletMinim() {
    private var bgColor: Int = 0
    private lateinit var fft: FFT
    private lateinit var filePlayer: FilePlayer
    private var type = 0

    private val wavFilePath = "../out/wav/vdelayTransposition.wav"
    ...
    private fun showSpectrum() {
        ...
        for (idx in 0 until fft.specSize()) {
            ...
            line(
                ...
                getScreenHeight().toFloat() - fft.getBand(idx) * 128
            )
        }
    }
